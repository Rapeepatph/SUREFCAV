...
namespace SUREF.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult ListUser()
        {
            ...
            List<ListUserModel> listUsers = new List<ListUserModel>();
            foreach(var item in Users)
            {
                ...
                model.id = item.Id;
                model.Role = role.Count==0?"This user is not assigned role":role[0];
                listUsers.Add(model);
            }
        ...
        public ActionResult Delete(string userId)
        {
            ...
            DeleteUserModel delModel = new DeleteUserModel();
            delModel.Id = userId;
            delModel.Username = user.UserName;
            delModel.Role = role.Count == 0 ? "This user is not assigned role" : role[0];
        ...
        public ActionResult DeleteUser(string id)
        {
            ...
            var result = UserManager.Delete(user).Succeeded;
            if (result)
            {
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public  ActionResult EditUser(ListUserModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                else if(role[0] != model.Role)
                {
                    this.UserManager.RemoveFromRole(user.Id, role[0]);
                    this.UserManager.AddToRole(user.Id, model.Role);
                }
                return RedirectToAction("ListUser");
